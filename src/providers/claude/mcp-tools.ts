/**
 * MCP tool server for OpenCode tool execution.
 *
 * Creates a fresh MCP server per request with read/write/edit/bash/glob/grep
 * tools. Each instance is needed because the SDK enforces one Protocol per
