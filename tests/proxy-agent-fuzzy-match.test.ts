...
import { fuzzyMatchAgentName } from "../src/providers/claude/agents";
...
describe("fuzzyMatchAgentName", () => {
  ...
  it("should lowercase and match", () => {
    ...
    expect(fuzzyMatchAgentName("Sisyphus-Junior", validAgents)).toBe(
      "sisyphus-junior",
    );
  });
  ...
  it("should match by prefix", () => {
    ...
    expect(fuzzyMatchAgentName("sisyphus", validAgents)).toBe(
      "sisyphus-junior",
    );
  });

  it("should match by substring", () => {
    expect(fuzzyMatchAgentName("looker", validAgents)).toBe(
      "multimodal-looker",
    );
